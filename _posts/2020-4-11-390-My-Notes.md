...
When I graduated college I had the great realization that, if I wasn't careful, I would have already achieved my maximum level of knowledge. I was fresh off classes like *Partial Differential Equations* and building a machine to range & locate RFID tags. I didn't want to read 45 and realize I was dumber than I had been at 25. I set out to review & summarize everything I ever learned into a sort of pseudo study guide for every class ever. As I wrote about in [my previous post](https://aarongilly.com/389-quarantine/#writing), I ultimately gave up on the idea (after doing a 50+ page outline, in fairness to myself).

Recently I've been reading a lot of books (again, wholly thanks to [Libby](https://www.overdrive.com/apps/libby/), [Axis 360](http://axis360.site.baker-taylor.com/), & [RbDigital](https://rbdigital.com/)), and taking lots of notes. Each book had its own little summary page. See the hero image[^two] at the top of this post. Somewhere in the middle of my 24th book summary, I realized that I was writing notes for *this* book that were incredibly similar to notes I'd previously written in a summary for other books... and that was happening a **lot**.

Enter [How to Take Smart Notes](https://www.amazon.com/How-Take-Smart-Notes-Nonfiction-ebook/dp/B06WVYW33Y/).[^three] It changed my goal. I didn't want a bunch of independent book summaries - I wanted *smart notes*.
...
![histogram]({{ site.url }}{{ site.baseurl }}/assets/images/390-tag-histogram.PNG)
...
[^two]:  [in case you don't know what a hero image is](https://en.wikipedia.org/wiki/Hero_image)
[^three]: Or, more specifically, other people's summaries of the book. ([one](https://fortelabs.co/blog/how-to-take-smart-notes)) ([two](http://www.markwk.com/smart-notes.html)). Those library apps I've given lots of credit to haven't yet produced a copy of this book.